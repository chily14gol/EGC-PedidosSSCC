  ...
  $.fn.extend({
    fixedTblHdrLftCol: function(options) {
      ...
      function setTableCSS(table) {
        ...
        table
          .css('border-collapse', 'separate') //.css('border-collapse', 'collapse')
      ...
      function setTbodyCSS(table) {
        var leftCornerWidth = getFixedLeftWidth(table);
        var tableWidth = getTableWidth(table);
		//console.log("tr: " + tableWidth + " - " + leftCornerWidth);
      ...
      function setLeftColumnCSS(table) {
        ...
        cols.each(function(i) {
		  ...
		  //console.log("td: " + $(this).css('max-width'));
      ...
      function recalHeight(table) {
        table.find('tbody tr:not(.gestampFilaVacia)').each(function() {
          var maxHeight = 0;
      ...
      function recalHeaderPosition(table) {
        ...
        table.find('tbody tr:first').each(function() {
          $(this).find('td').each(function() {
			...
			//console.log("recal: " + position.left);
      ...
      function init(table) {
		  ...
		  console.log("init fixedTblHdrLftCol");
